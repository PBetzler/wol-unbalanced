...
| **Raven** | 100/200, 2 supply | All AP except Hunter-Seeker-as-attack; **summons permanent** (PDD/Auto-Turret Duration 3600); **free kit** (PDD/Turret/Seeker energy → 0, player-only); Interference Matrix; Anti-Armor Missile; **free permanent cloak (0.3.12)**; **now scales armor with the combined Eng Bay upgrade** (0.3.13 added base Raven armor to the ship-armor base-Level upgrades) | ✅ free-kit + permanent summons (owner's rule-9-safe design); 🟡 [GAME] confirm armor scaling; ⛔ Raven-itself-as-autocast-PDD (owner rejected a hidden always-on weapon) |
