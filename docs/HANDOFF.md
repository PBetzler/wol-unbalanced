...
grants their full research-point yield; pure `LibWoLUnbalanced.galaxy` trigger work,
independent-Opus-reviewed, [GAME]-pending the owner's campaign-flow playtest).
